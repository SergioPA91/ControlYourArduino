    ...
    if ( (waitForData == 0) && executeMultiByteCommand ) { // got the whole message
      switch (executeMultiByteCommand) {
        ...
        case ANALOG_REFERENCE:
          if (currentAnalogReferenceCallback)
            (*currentAnalogReferenceCallback)(storedInputData[1], storedInputData[0]);
          break;
        case INTERRUPT_CONFIG:
          if (currentInterruptConfigCallback)
            (*currentInterruptConfigCallback)(storedInputData[1], storedInputData[0]);
          break;
...
void FirmataClass::attach(byte command, callbackFunction newFunction)
{
  switch (command) {
    ...
    case ANALOG_REFERENCE: currentAnalogReferenceCallback = newFunction; break;
    case INTERRUPT_CONFIG: currentInterruptConfigCallback = newFunction; break;
  }
}
