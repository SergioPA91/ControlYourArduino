...
//
#define INTERRUPT_CONFIG        0xF2 // set config for interrupts (pin 2 and 3)
#define INTERRUPT_CAPTURED      0xF3 // set config for interrupts (pin 2 and 3)
#define SET_PIN_MODE            0xF4 // set a pin to INPUT/OUTPUT/PWM/etc
#define SET_DIGITAL_PIN_VALUE   0xF5 // set value of an individual digital pin
#define ANALOG_REFERENCE        0xF6 // Set config Analog Reference
//
...
#define I2C_SCAN                0x56 // Scan I2C devices connected
#define TIME_CAPTURE            0x57 // set time capture data analog/digital 
#define NOTONE_CONFIG           0x58 // set noTone function
#define TONE_CONFIG             0x59 // set pin, freq, duration for tone function 
...
class FirmataClass
{
  ...
  private:
    ...
    callbackFunction currentAnalogReferenceCallback;
    callbackFunction currentInterruptConfigCallback;
